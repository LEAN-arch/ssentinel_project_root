...
with tabs[1]: # Testing
    ...
    if health_df_period.empty:
        ...
        try:
            ...
            insights = prepare_clinic_lab_testing_insights_data(kpis, health_df_period)
    ...
    if full_health_df.empty:
        ...
        try:
            ...
            if not forecast_df.empty:
                ...
                color_map = {
                    "Critical Low": get_theme_color("risk_high"),
                    "Warning Low": get_theme_color("risk_moderate"),
                    "Sufficient": get_theme_color("risk_low")
                }
